...
#define PORT_B "22256"   // the port the main server will be connecting to
...
int main(void)
{
    printf("ServerB is up and running using UDP on port %s.\n", PORT_B);

    // set up UDP
    int sockfd;
    sockfd = setup_listener(HOST, PORT_B);
    ...
    printf("ServerB finished sending a list of usernames to Main Server.\n");
